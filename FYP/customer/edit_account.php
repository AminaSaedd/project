		<?php 	
				...
				$lname = $row_customer['LastName'];
				$number = $row_customer['phone_number'];
				$email = $row_customer['email'];
				$pass = $row_customer['PASSWORD'];
				$join = $row_customer['join_date'];
		...
		<form action="" method="post" enctype="multipart/form-data">
					...
					<table align="center" width="750">
						...
						<tr>
							...
							<td><input type="text" name="c_Phone" value="<?php echo $number;?>" required/></td>
						</tr>
						<tr>
						...
						<tr>
							<td align="right">Customer joinDate:</td>
							<td><input type="text" name="join_date" value="<?php echo $join;?>" required/></td>
						</tr>
						<tr>
...
<?php 
	if(isset($_POST['update'])){
		...
		move_uploaded_file($c_image_tmp,"customer_images/$c_image");
		 ...
		 $update_c = "update customers set FirstName='$c_name', email='$c_email', PASSWORD='$c_pass', image='$c_image' where customer_id='$customer_id'";
