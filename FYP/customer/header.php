  ...
  <div class="container">
   ...
   <div class="collapse navbar-collapse" id="mynav">
    <ul class="navbar-nav " id="call">
         <li class="nav-item px-2" style="margin-left: -130px;"><a href="adminindex.php" class="nav-link active"><i class="fa fa-phone"></i><span>customer care</span> <span>+252634337090</span></a></li> 
...
<?php
    ...
    if(!isset(($_SESSION['check_user']))){
        ...
        echo " <a href='login.php'style='color:orange;'>myprofile </a>";
        ...
        echo "<a href='customer/my_account.php' style='color:orange;'>  $name </a> ";
      }
?>
    </li>
      <li class="nav-item">
...
<div id="top-menu-wrap" >
  ...
  <li class="nav-item"><a href="Category.php?id=2?>" >Islamic </a></li>
  <li class="nav-item"><a href="Category.php?id=2" >KinderGarten KG</a></li>
<li class="nav-item"><a href="Category.php?id=1" >Primary </a></li>
<li class="nav-item"><a href="Category.php?id=2">Local publications</a></li>
 <li class="nav-item"><a href="Category.php?id=2">Secondary</a></li>
<li class="nav-item"><a href="Category.php?id=2">General Reading-English</a></li>
<li class="nav-item"><a href="Category.php?id=2">General Reading-arabic</a></li>
</ul>                       
</div>                                
</div>           
</nav>   
