...
<nav class="navbar navbar-expand-sm  bg-dark navbar-dark">
  ...
  <div class="container">
   ...
   <ul class="navbar-nav">
    ...
    <i class="fa fa-user-circle-o"></i>welcome to preveen
     </a> 
     <div class="dropdown-menu">
      <a href="profile.html" class="dropdown"><i class="fa fa-user-circle">Profile</i></a> <br>
      <a href="Settings.html" class="dropdown"><i class="fa fa-gear">Settings</i></a>  
     </div>
    </li> 
    <li class="nav-item">
  ...
  <div class="row">
   <div class="col-md-9">
    <div class="card">
      ...
      <h5 class="text-center ">books detail</h5>
     </div>
     <!DOCTYPE html>
<html>
<head>
...
<?php }?>
   ...
   <div class="card card-success mb-3  text-center text-white" style="background-color: #28a745;"> 
    <div class="card-block">
      ...
      <a href="category.php.php" class="btn btn-outine-secondary text-white">View</a>
    </div>
   </div>
   <div class="card card-warning mb-3  text-center text-white" style="background-color: #ffc107;"> 
    <div class="card-block">
      ...
      <a href="users" class="btn btn-outine-secondary text-white">View</a>
    </div>
   </div>
