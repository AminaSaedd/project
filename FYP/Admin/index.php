...
<nav class="navbar navbar-expand-sm  bg-dark navbar-dark">
  ...
  <div class="container">
   ...
   <a href="index.php" class="navbar-brand mr-3">HemaBooks</a>
   <div class="collapse navbar-collapse" id="mynav">
    <ul class="navbar-nav">
         <li class="nav-item px-2"><a href="index.php" class="nav-link active" >Dashbord</a></li> 
        <li class="nav-item px-2"><a href="index.php?category" class="nav-link">Category</a></li> 
         <li class="nav-item px-2"><a href="index.php?books" class="nav-link">Books</a></li> 
        <li class="nav-item px-2"><a href="index.php?users" class="nav-link">Users</a></li>    
    </ul> 
   <ul class="navbar-nav">
    ...
    <li class="nav-item">
     <a href="index.php?payment" class="nav-link "><i class="">Payment Info</i></a> 
    </li>
   </ul> 
   </div>
  </div>
 ...
 <div class="container">
  ...
  <a href="addbook.php" class="btn btn-warning btn-block " data-toggle="modal" data-target="#addusermodel">
    ...
    Add Admin
     ...
     <div class="col-md-3">
  <a href="sales.php" class="btn btn-danger btn-block " data-toggle="modal" data-target="#reportmodel">
  ...
  $row3=mysqli_fetch_array($result3);
   ...
   <div class="col-md-3" >
    ...
    <div class="card-block">
      ...
      <a href="index.php?books" class="btn btn-outine-secondary text-white">View</a>
    </div>
   </div>
   <div class="card card-success mb-3  text-center text-white" style="background-color: #28a745;"> 
    <div class="card-block">
      ...
      <a href="index.php?category" class="btn btn-outine-secondary text-white">View</a>
    </div>
   </div>
   <div class="card card-warning mb-3  text-center text-white" style="background-color: #ffc107;"> 
    <div class="card-block">
      ...
      <a href="index.php?users" class="btn btn-outine-secondary text-white">View</a>
    ...
    <div class="card-block">
      ...
      <a href="index.php?view_orders" class="btn btn-outine-secondary text-white">View </a>
...
<div class="modal fade" id="reportmodel">
 <div class="modal-dialog modal-lg">
 <div class="modal-content">
  ...
  <div class="modal-body">
   <form action="Report_code.php" enctype="multipart/form-data" method="post">
  </div>
   <div class="form-group">
   <label class="form-control" for="adminname">Seach</label> 
   <input type="text" name="ID" class="form-control">
  </div>
  <div class="modal-footer">
 
  
   <button class="btn btn-danger" name="submit">View  Specific Report</button>
   
     </form> 
     <form  action="Report.php" enctype="multipart/form-data" method="post">
   <input type="hidden" name="ID" class="form-control">
  
  <button class=" btn btn-success" name="submit_all"> View All Sales Report</button>
     </form>
      <button class="btn btn-secondary" data-dismiss="modal">close</button> 
  </div>
 </div>
